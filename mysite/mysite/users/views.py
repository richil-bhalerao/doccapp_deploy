...
def upload(request):
    ...
    if request.POST:
            ...
            payload = {'Name':contentName, 'fileName':path, 'Description':description, 'sub_category':subCategory, "prof_username":username, "link":"", "Feedback":[], "Rating": 0, "Type":"", "permalink": permalink, "count":0, "Questions":[]}
